...
var NAMESPACE_TRANSLATIONS_AUTH = "Auth";
function useAuth() {
    var _a = (0, react_1.useState)(undefined), user = _a[0], setUser = _a[1];
    var _b = (0, react_1.useState)(true), loading = _b[0], setLoading = _b[1];
    var t = (0, next_intl_1.useTranslations)(NAMESPACE_TRANSLATIONS_AUTH);
    (0, react_1.useMemo)(function () {
        function fetchUser() {
            return __awaiter(this, void 0, void 0, function () {
                var response, userData, _1, errorMessage;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 5:
                            _1 = _b.sent();
                            errorMessage = server_1.default.renderToString((_a = t.rich("authError", { contactLink: ContactLink_1.default })) !== null && _a !== void 0 ? _a : t("authError"));
