...
export declare enum AffiliationStatus {
    Approved = "approved",
    Rejected = "rejected"
}
export type { GetAffiliationsResponse, PostAffiliationPayload, PostAffiliationsResponse, PatchAffiliationsPayload, PatchAffiliationsResponse, PutAffiliationsResponse, };
