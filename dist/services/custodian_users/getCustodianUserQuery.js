...
exports.default = getCustodianUserQuery;
var getCustodianUser_1 = __importDefault(require("./getCustodianUser"));
function getCustodianUserQuery(custodianUserId, options) {
    return __assign({ queryKey: __spreadArray([
            ...
            return (0, getCustodianUser_1.default)(queryKey[1], __assign({ error: {
