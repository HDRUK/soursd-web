...
export default function usePaginatedCustodianOrganisationUsers(custodianId: number, organisationId: number, options?: GetCustodianOrganisationUsersQuery): any;
export {};
