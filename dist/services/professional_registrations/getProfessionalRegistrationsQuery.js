...
exports.default = getProfessionalRegistrationsQuery;
var getProfessionalRegistrations_1 = __importDefault(require("./getProfessionalRegistrations"));
function getProfessionalRegistrationsQuery(registry_id, options) {
    return __assign({ queryKey: __spreadArray([
            ...
            return (0, getProfessionalRegistrations_1.default)(queryKey[1], __assign({ error: {
