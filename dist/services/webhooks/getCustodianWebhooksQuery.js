...
exports.default = getCustodianWebhooksQuery;
var getCustodianWebhooks_1 = __importDefault(require("./getCustodianWebhooks"));
function getCustodianWebhooksQuery(custodianId, options) {
    return __assign({ queryKey: __spreadArray([
            ...
            return (0, getCustodianWebhooks_1.default)(queryKey[1], __assign({ error: {
