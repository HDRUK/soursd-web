...
export default function getCustodianWebhooksQuery(custodianId: number, options?: QueryOptions) {
  return {
    queryKey: ["getCustodianWebhooks", custodianId, ...(options?.queryKeySuffix || [])],
    queryFn: ({ queryKey }) =>
